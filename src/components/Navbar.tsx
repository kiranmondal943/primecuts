...
import SearchOverlay from './SearchOverlay'; // Import the Search Engine
...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-10 z-50 bg-white shadow-sm border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        ...
        {/* CENTER: DESKTOP NAVIGATION (100% LINKED) */}
        <div className="hidden lg:flex space-x-5 text-sm font-semibold text-[#1D3557]">
          ...
          <Link href="/" className="text-[#E63946] hover:text-red-700 transition font-bold">Offers</Link>
          <Link href="/recipes" className="hover:text-[#E63946] transition">Recipes</Link>
          <Link href="/subscriptions" className="hover:text-[#E63946] transition">Subscriptions</Link>
          <Link href="/support" className="hover:text-[#E63946] transition">About</Link>
          <Link href="/support" className="hover:text-[#E63946] transition">Blog</Link>
        </div>
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <button 
            ...
            className="text-[#1D3557] hover:text-[#E63946] transition focus:outline-none"
          >
            <Search size={20} />
          </button>
